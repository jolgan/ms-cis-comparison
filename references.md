...
This project uses two publicly available, CC BY 4.0 licensed clinical datasets drawn from Lithuanian and Mexican CIS patient cohorts.
...
2. Daniel EC, Tirunagari S, Batth K, Windridge D, Balla Y. Interpretable machine learning for predicting multiple sclerosis conversion from clinically isolated syndrome. *medRxiv*. 2024. https://doi.org/10.1101/2024.07.18.24310578

## Clinical Background

1. Multiple Sclerosis International Federation. Atlas of MS 2020. https://www.msif.org/about-ms/what-is-ms/

2. National Institute for Health and Care Excellence (NICE). Multiple sclerosis in adults: management. NICE guideline NG220. 2022. https://www.nice.org.uk/guidance/ng220

3. McDonald WI, et al. Recommended diagnostic criteria for multiple sclerosis. *Annals of Neurology*. 2001;50(1):121–127. (McDonald Criteria — the diagnostic framework underpinning CIS classification)
